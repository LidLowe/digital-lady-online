    ...
    private details = [
        {
            ...
            title: 'Coding School',
            icon: 'android',
            description: 'Здесь мы исследуем и разрабатываем проекты, связанные с мобильными технологиями и программным обеспечением. Лаборатория позволяет тестировать возможности программных продуктов на практике.',
            major: [
                'Разработка на Java/Kotlin',
                'Обучение ИИ',
                'Работа с Big Data'
            ],
            techBase: 'Высокопроизводительные ноутбуки с графикой RTX, современные моноблоки, интерактивная доска.'
        },
        {
            id: 2,
            title: 'Apple Lab',
