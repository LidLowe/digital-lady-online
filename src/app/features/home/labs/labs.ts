...
export class Labs {
    items = [
        { id: 1, title: 'Coding School', description: 'Разработка решений для мобильных платформ.', icon: "android"},
        ...
        { id: 4, title: 'Cisco Academy', description: 'Исследование сетевых технологий и кибербезопасности.', icon: "network"}
    ];
}
